...
def set_values(geom, mean, cls):
    ...
    geom.pos = new_pos
    geom.rgba = [0.694, 0.612, 0.851, 0.4]  # light purple color + 0.2 translucency
...
if __name__ == "__main__":
    ...
    # ]
    list2 = [
        (1, [-0.023849, 0.0096752, 178.66]),
        (1, [-0.023851, -0.1411, 139.83]),
        (3, [0.18976, -0.090159, 106.99]),
        (3, [0.10767, -0.070272, 115.28]),
        (4, [0.094892, 0.030336, 163.03]),
        (4, [0.16658, -0.18208, 162.11]),
        (4, [0.083753, -0.19676, 153.25]),
        (12, [0.27523, 0.025999, 132.16]),
        (12, [0.31829, -0.17217, 137.73]),
    ]
