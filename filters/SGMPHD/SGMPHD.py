...
class SGMPHD_GaussianMixture:
    ...
    def copy(self):
        ...
        for P1 in self.P:
            P.append(P1.copy())
        return SGMPHD_GaussianMixture(w, m, P)
...
def thinning_and_displacement(
    v: SGMPHD_GaussianMixture, p, F: np.ndarray, Q: np.ndarray
):
    """
...
class SGMPHD:
    ...
    def spawn_mixture(self, v: SGMPHD_GaussianMixture) -> SGMPHD_GaussianMixture:
        """
    ...
    def prediction(self, v: SGMPHD_GaussianMixture) -> SGMPHD_GaussianMixture:
        """
    ...
    def correction(
        self, v: SGMPHD_GaussianMixture, Z: List[np.ndarray]
    ) -> SGMPHD_GaussianMixture:
        """
    ...
    def pruning(self, v: SGMPHD_GaussianMixture) -> SGMPHD_GaussianMixture:
        """
        See https://ieeexplore.ieee.org/document/7202905 for details
        """
        ...
        m = [v.m[i] for i in I]
        P = [v.P[i] for i in I]
        v = SGMPHD_GaussianMixture(w, m, P)
    ...
    def state_estimation(self, v: SGMPHD_GaussianMixture) -> List[np.ndarray]:
        X = []
